        ...
        try {
            ...
            function windowsToCygwinPath(windowsPath) {
              ...
              if(isWin){
                ...
                cygwinPath = cygwinPath.replace(/^([A-Z]):/, (match, driveLetter) => {
                    return '/cygdrive/' + driveLetter.toLowerCase();
                });
              
                (0, core_1.info)(`Mapped path ${windowsPath} to ${cygwinPath}`)
                return cygwinPath;
            ...
            yield (0, execute_1.execute)(`rsync -q -av --checksum --progress ${windowsToCygwinPath(action.folderPath)}/. ${action.targetFolder
